    ...
    <div className="">
      ...
      <div className="ml-2 inline-flex">
        {OPTIONS.map((option, index) => (
          <a key={index} className="ml-2 w-[160px] h-[32px] rounded-2xl bg-[#EDEDF0] text-center flex items-center justify-center" id="option">
            {option}
          </a>
        ))}
      </div>

      <div className="grid grid-cols-4 gap-4 px-4 border-b-1 border-[#EDEDF0] mb-10 rounded-2xl shadow-md">
      ...
      <div className="grid grid-cols-3 space-x-3 pb-[100px]">
